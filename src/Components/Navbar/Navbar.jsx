    ...
    <div>
      ...
      <div className="navbar_middle flex items-center justify-center bg-[#f0f2f3] w-full h-[84px]">
        <div className="lg:container grid grid-cols-3 items-center">
          ...
          <div className="search_box">
            <form action="#" className="max-w-[443px] h-[44px] relative">
              <input
                ...
                className="max-w-[443px] text-black  w-full h-full bg-white rounded-lg  pl-4"
              />
          ...
          {/* navbar middle right */}
          <div className="navbar_middle_right flex items-center ml-4 gap-4">
            <button className="btn capitalize bg-white">
              <ShoppingCart className="text-black" />{" "}
              <p className="text-black">cart</p>{" "}
              <div className="badge badge-sm text-black bg-[#029fae]">2</div>
            </button>
            <button className="btn capitalize bg-white">
        ...
        <div className="lg:container flex items-center justify-between">
          <div className="navbar_bottom_left flex items-center gap-8 ">
            <div className="dropdown dropdown-start">
              <div tabIndex={0} role="button" className="btn m-1 flex items-center gap-5 bg-[#f0f2f3] capitalize">
                <Menu  className=" text-black"/> <p className="text-black">all categories</p>
              </div>
              <ul
                tabIndex={0}
                className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm"
